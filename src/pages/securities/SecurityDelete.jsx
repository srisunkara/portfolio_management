...
export default function SecurityDelete() {
  ...
  return (
    <div style={{ maxWidth: 520 }}>
      <h1 style={{ marginTop: 0 }}>Delete Security</h1>
      <p>Are you sure you want to delete security with ID {id}?</p>
      ...
      <div style={{ display: "flex", gap: 8 }}>
        ...
        <Link to="/securities" style={{ background: "#e2e8f0", color: "#0f172a", padding: "10px 12px", borderRadius: 8, textDecoration: "none" }}>
          Cancel
        </Link>
      </div>
    </div>
