...
rollup main.jsx --format iife --name "myBundle" --file bundle.js
```
...
rollup main.jsx --format cjs --file bundle.js
```
...
rollup main.jsx --format umd --name "myBundle" --file bundle.js
```
